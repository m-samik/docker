function myoutput() {
    ...
    ping.open("GET", "http://192.168.1.2/cgi-bin/dockerstart.py?iname="+iname+"&cname="+cname, true);
    ping.send();
...
function myoutput2() {
    ...
    var ping= new XMLHttpRequest();
    ping.open("GET", "http://192.168.1.2/cgi-bin/dockerstatus.py?cmd="+cmd, true);
    ping.send();
    ping.onload = function() { 
        var output = ping.responseText;
        console.log(output);
...
function myoutput3() {
    ...
    var ping= new XMLHttpRequest();
    ping.open("GET", "http://192.168.1.2/cgi-bin/dockerstop.py?dstop="+dstop, true);
    ping.send();
    ping.onload = function() { 
        var output = ping.responseText;
        console.log(output);
